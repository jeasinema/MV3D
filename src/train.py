...
if __name__ == '__main__':
    ...
    with BatchLoading3(tags=training_dataset, require_shuffle=True, batch_size=args.batch_size, use_precal_view=True) as training:
      with BatchLoading3(tags=validation_dataset, require_shuffle=False, use_precal_view=True) as validation:
